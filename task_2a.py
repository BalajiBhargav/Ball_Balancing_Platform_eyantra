...
def start_simulation(rec_client_id):
    """
    Purpose:
    ---
    ...
    return_code = sim.simxStartSimulation(
        rec_client_id, sim.simx_opmode_oneshot)
...
def get_vision_sensor_image(rec_client_id, cam_handle):
    ...
    #return_code, cam_handle = sim.simxGetObjectHandle(client_id, 'vision_sensor_1', sim.simx_opmode_blocking)

    return_code, image_resolution, vision_sensor_image = sim.simxGetVisionSensorImage(
        rec_client_id, cam_handle, 1, sim.simx_opmode_blocking)
...
def stop_simulation(rec_client_id):
    """
    Purpose:
    ---
    ...
    return_code = sim.simxStopSimulation(
        rec_client_id, sim.simx_opmode_oneshot_wait)
